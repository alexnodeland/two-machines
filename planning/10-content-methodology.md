...
- `/sources` is generated from [12 · References](12-references.md). Nothing is cited that
  is not in that file.
...
([D-030](00-decision-log.md#d-030--no-aphorism-database-ever--firm)), each in context,
...
- "Frippertronics" capitalised, used descriptively, never as the site's brand
  ([D-004](00-decision-log.md#d-004--descriptive-title-coined-term-used-inside--firm)).
...
- Colour follows the semantics in [05 §2](05-design-system.md#2-colour-is-semantic): a
