...
([07 §3](07-tech-stack.md#3-bun-the-sharp-edges)).
...
| No `href="/..."` that omits the prefix | [D-029](00-decision-log.md#d-029--github-pages-project-page-therefore-pathprefix-is-required--firm) |
| `quiver.worklet.js` and `quiver_bg.wasm` present at the prefixed path | [D-037](00-decision-log.md#d-037--worklet-and-wasm-urls-must-be-prefix-aware--firm) |
...
That last point matters given [D-041](00-decision-log.md#d-041--the-prototype-engine-becomes-the-behavioural-oracle--firm):
...
non-commercial ([D-033](00-decision-log.md#d-033--non-commercial--firm)), which is also
