...
arithmetic ([D-018](00-decision-log.md#d-018--longestinterlock-is-the-number-we-print--firm)).
...
**Meters only.** [D-031](00-decision-log.md#d-031--no-king-crimson-transcriptions-or-tab--firm)
and [D-017](00-decision-log.md#d-017--the-cycles-engine-models-meters-never-parts--firm).
...
Scheduling per [03 §7](03-audio-engine-spec.md#7-scheduling-and-timing): 25 ms timer,
...
- Canvas carries an `aria-live` textual summary — see
  [06 §4](06-accessibility-and-interaction.md).
