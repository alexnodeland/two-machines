...
- **Output is limited** ([03 §6](03-audio-engine-spec.md#6-three-gaps-in-quiver-and-how-they-are-closed)).
...
- Written to the same standard as the prose, per
  [10 · Content methodology](10-content-methodology.md). This is content, not alt text.
...
([D-011](00-decision-log.md#d-011--pixels-map-to-centimetres-at-a-constant-scale--firm)).
