...
Constrained by [01 · Thesis and scope](01-thesis-and-scope.md).
...
[01 §4](01-thesis-and-scope.md#4-structure). Readers arrive sideways from search, the
...
size budget (see [05 · Design system](05-design-system.md)), its **sources**, and its
...
| **Diagram** | Descendant of Eno's *Discreet Music* schematic. Must be drawn from the real sleeve, not from memory — see [14](14-open-questions.md). |
...
([D-005](00-decision-log.md#d-005--non-hagiographic-lineage-is-a-launch-requirement-not-a-nicety--firm)).
...
- **Code** — a small implementation, MIT-licensed, that *is* the site's engine. Now:
  quiver + AudioWorklet ([D-035](00-decision-log.md#d-035--the-rig-is-a-quiver-patch-running-in-an-audioworklet--firm)).
...
rather than Gurdjieff directly ([D-034](00-decision-log.md#d-034--cite-robertson-rather-than-gurdjieff-directly--firm)).
...
| **Rights** | **Meters only.** [D-031](00-decision-log.md#d-031--no-king-crimson-transcriptions-or-tab--firm), guarantee printed on the page. |
...
v1 ([01 §5](01-thesis-and-scope.md#5-scope-boundaries)). Honesty about a gap beats
padding it.
...
Generated from [12 · References](12-references.md), which is the single source of truth.
