...
> republication rather than citation ([11 §3](11-rights-and-legal.md#3-third-party-material)).
...
| **Guitar Craft aphorisms + Fripp's usage terms** — [partitasmusic.com/aphorisms](https://partitasmusic.com/aphorisms) | ✅ live | **Read the usage terms before quoting anything.** Governs [D-030](00-decision-log.md#d-030--no-aphorism-database-ever--firm). |
...
Per [D-034](00-decision-log.md#d-034--cite-robertson-rather-than-gurdjieff-directly--firm),
...
| Source | Used by |
|---|---|
| **Chris Wilson, "A Tale of Two Clocks"** — [web.dev/articles/audio-scheduling](https://web.dev/articles/audio-scheduling) | [03 §7](03-audio-engine-spec.md), [04](04-cycles-engine-spec.md). The canonical lookahead-scheduling reference; MDN recommends it directly. |
| MDN — Web Audio API: advanced techniques | [03](03-audio-engine-spec.md) |
| **Vitest — coverage config** — [vitest.dev/config/coverage](https://vitest.dev/config/coverage) | [08](08-testing-strategy.md). Source of the `all: true` requirement and threshold semantics. |
| **Gatsby — How Gatsby works with GitHub Pages** — [gatsbyjs.com](https://www.gatsbyjs.com/docs/how-to/previews-deploys-hosting/how-gatsby-works-with-github-pages/) | [09](09-ci-cd.md). Source of the `pathPrefix` rule in [D-029](00-decision-log.md#d-029--github-pages-project-page-therefore-pathprefix-is-required--firm). |
| **Bun — package manager docs** — [bun.com/docs/pm/cli/install](https://bun.com/docs/pm/cli/install) | [07](07-tech-stack.md). `trustedDependencies` and lifecycle-script behaviour. |
| `standardized-audio-context-mock` — [npm](https://www.npmjs.com/package/standardized-audio-context-mock) | [08](08-testing-strategy.md). jsdom does not implement Web Audio; this is the mocking option. |
| WCAG 2.2 — 1.4.2 Audio Control, 2.3.3 Animation from Interactions | [06](06-accessibility-and-interaction.md) |
| Quiver — browser integration guide (in-repo: `docs/src/how-to/browser-integration.md`) | [03 §5](03-audio-engine-spec.md) |
...
| **Guitar Craft Monograph No. 3** (1987 poster) | An image, for reference only — **not reproduction** ([D-030](00-decision-log.md#d-030--no-aphorism-database-ever--firm)). Source of the harmonic-series statement used in chapter 3.2. |
...
[D-003](00-decision-log.md#d-003--editorial-claims-are-visibly-marked-in-the-ui--firm)
