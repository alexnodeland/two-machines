...
([D-012](../decisions/012-separate-monitor-and-record-head.md)),
...
([D-037](../decisions/037-prefix-aware-worklet-wasm-urls.md)).
...
pitch glide [D-014](../decisions/014-ramped-delay-pitch-glide.md)
...
([Testing](testing-strategy.md) tier 3). jsdom cannot do this — it does not
