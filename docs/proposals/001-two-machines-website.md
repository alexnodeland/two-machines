---
title: "Two Machines — thesis and scope"
number: 1
status: accepted
...
# RFC-001: Two Machines — thesis and scope
...
carries a visible mark ([D-003](../decisions/003-editorial-claims-marked.md)).
...
([D-002](../decisions/002-website-not-book.md)).
...
| **Hosted audio of any kind** | [D-032](../decisions/032-no-hosted-audio.md). Legal. | Never. |
| **Aphorism collection, index, or widget** | [D-030](../decisions/030-no-aphorism-database.md). Legal, and the most likely takedown vector. | Never. |
| **King Crimson tab or transcription** | [D-031](../decisions/031-no-transcriptions-or-tab.md). Legal. | Never. |
| **Commercial anything** | [D-033](../decisions/033-non-commercial.md). No ads, no affiliates on gear pages, no merch. | Never. |
...
- **Tier 1 sources gate the launch, not a later phase.** Robertson, Tamm,
  *The Guitar Circle* and *Bruford and the Beat* must all be in hand before chapters 7–10
  can be written. See [Roadmap](../plans/001-build-and-launch.md) — this is the critical path, and it
